...
class TestListWidget:
    ...
    def test_add_new_item(self):
        with mock.patch.object(ListItem, "__init__", lambda w, x, y, z,: None):
            ...
            assert self._widget.file_dict == {'file': {"File Name" : 'name', 'FMS': ''}}

    def test_add_new_item_two(self):
        with mock.patch.object(ListItem, "__init__", lambda w, x, y, z,: None):
            self._widget.file_dict = {'file': {"File Name" : 'name', 'FMS': ''}}
            ListItem.get_name = MagicMock(return_value="name")
            self._widget.files_added = MagicMock()
            ...
            assert self._widget.file_dict == {'file': {"File Name" : 'name', 'FMS': ''}, 'file2': {"File Name" : 'name', 'FMS': ''}}

    def test_add_new_item_repeat(self):
        with mock.patch.object(ListItem, "__init__", lambda w, x, y, z,: None):
            self._widget.file_dict = {'file': {"File Name" : 'name', 'FMS': ''}, 'file2': {"File Name" : 'name', 'FMS': ''}}
    ...
    def test_remove_item_curr_item(self):
        ...
        self._widget.file_dict = {'file': {"File Name" : 'name', 'FMS': ''}, 'file2': {"File Name" : 'name', 'FMS': ''}, 'file3': {"File Name" : 'name', 'FMS': ''}}
        ...
        assert self._widget.file_dict == {'file': {"File Name" : 'name', 'FMS': ''},  'file3': {"File Name" : 'name', 'FMS': ''}}
